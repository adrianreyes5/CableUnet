...
<html>
<head>
	<title>Registro de servicio a telefonía</title>
...
<body class="telefonia">
  ...
  <form id="contact" action="../confg_admin/servicios_db.php"  method="post">
    <h3>Registro plan de telefonía</h3>
    <fieldset>
      <input placeholder="Plan" type="text" name="plan" tabindex="1" required autofocus>
    </fieldset>
    <fieldset>
      <input placeholder="Minutos" type="text" name="minutos" tabindex="2" required>
    </fieldset>
    <fieldset>
      <input placeholder="Precio" type="text" name="precio" tabindex="3" required>
    </fieldset>
    <fieldset>
      <button name="enviar_tlf" type="submit" id="contact-submit" data-submit="...Sending">Registrar</button>
    </fieldset>
  </form>
